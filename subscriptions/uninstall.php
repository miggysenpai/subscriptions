...
//delete all from DB
$db->query("DROP TABLE `plg_sub_cost`, `plg_sub_plans`, `plg_sub_settings`, `plg_sub_stripe`, `plg_sub_stripe_custID`");

//delete sunscription.php in usersc/
$subscription_php = $abs_us_root.$us_url_root.'usersc/subscription.php';
if (file_exists($subscription_php)) {
    unlink($subscription_php);
}
